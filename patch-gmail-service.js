...
// Create a patched Gmail service with proper timeout handling
const gmailServicePatch = `
...
// Write the patched service to a file
fs.writeFileSync('gmail-service-fixed.ts', gmailServicePatch);
console.log('✅ Gmail service patch created: gmail-service-fixed.ts');
console.log('This patch includes:');
console.log('- Connection timeout: 10 seconds');
console.log('- Socket timeout: 10 seconds');
console.log('- Email send timeout: 10 seconds');
console.log('- Connection verification timeout: 5 seconds');
console.log('- Retry mechanism with 2 attempts');
console.log('- Connection pooling for better performance');
console.log('- Proper error handling to prevent hanging');
