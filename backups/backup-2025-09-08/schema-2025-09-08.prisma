...
datasource db {
  provider = "postgresql"
  url      = "postgresql://auy1jll:_Zx-nake%406172@localhost:5432/pizzax"
}
...
model OrderItem {
  ...
  createdAt          DateTime                 @default(now())
  updatedAt          DateTime                 @updatedAt
  itemType           OrderItemType            @default(PIZZA)
  specialtyCalzoneId String?
  specialtyPizzaId   String?
  ...
  pizzaSize          PizzaSize?               @relation(fields: [pizzaSizeId], references: [id])
  specialtyCalzone   SpecialtyCalzone?        @relation(fields: [specialtyCalzoneId], references: [id])
  specialtyPizza     SpecialtyPizza?          @relation(fields: [specialtyPizzaId], references: [id])
...
model CartItem {
  ...
  createdAt          DateTime                @default(now())
  updatedAt          DateTime                @updatedAt
  itemType           CartItemType            @default(PIZZA)
  specialtyCalzoneId String?
  specialtyPizzaId   String?
