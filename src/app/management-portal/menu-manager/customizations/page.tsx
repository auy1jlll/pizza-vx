        ...
        <div className="bg-white/10 backdrop-blur-xl border-b border-white/20 px-6 py-8">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            <div className="flex gap-3">
              <Link href="/management-portal/menu-manager/customizations/new" className="bg-gradient-to-r from-purple-500 to-indigo-500 text-white px-6 py-3 rounded-xl hover:scale-105 transition-all duration-300 font-semibold shadow-xl">
                <Plus className="h-5 w-5 inline mr-2" />
                Add Group
              </Link>
              <Link href="/management-portal/menu-manager/customization-options/new" className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-6 py-3 rounded-xl hover:scale-105 transition-all duration-300 font-semibold shadow-xl">
        ...
        <div className="p-6">
          ...
          <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-xl border border-white/20 rounded-2xl p-6 mb-8">
            <div className="flex items-center justify-between">
              ...
              <Link 
                href="/management-portal/menu-manager/customization-groups"
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex gap-2">
                      <button 
                        onClick={() => router.push(`/management-portal/menu-manager/customization-groups/${group.id}`)}
