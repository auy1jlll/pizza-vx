  ...
  const calzoneComponents = [
    {
      ...
      icon: CakeIcon,
      href: '/admin/sizes', // Reuse same sizes as pizzas
      color: 'bg-amber-500',
    ...
    },
    {
      ...
      href: '/admin/crusts', // Reuse same crusts as pizzas
      color: 'bg-orange-500',
    ...
    },
    {
      ...
      icon: BeakerIcon,
      href: '/admin/sauces', // Reuse same sauces as pizzas
      color: 'bg-red-500',
    ...
    },
    {
      ...
      icon: SparklesIcon,
      href: '/admin/toppings', // Reuse toppings as fillings
      color: 'bg-green-500',
