...
import { z } from 'zod';
import { ArrowLeft, Save, Eye, Globe, Search, Lightbulb } from 'lucide-react';
          ...
          <div className="container mx-auto px-4 py-4">
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h1 className={`${designSystem.h2} text-white`}>Create New Page</h1>
                  <p className={`${designSystem.small} text-white/70`}>
                    Build SEO-optimized content for your restaurant
                  </p>
                </div>
              </div>
